...
В проекте есть дополнительные заготовки/наработки (включая legacy-файлы и вспомогательные страницы). Для сдачи рекомендуется ориентироваться на маршруты и модули, перечисленные в этом README.
